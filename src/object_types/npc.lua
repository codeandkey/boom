...
return {
    init = function(this)
        ...
        this.spr_idle = sprite.create('obj/32x32_hero.png', 32, 32, 0.1)
        this.spr_walk = sprite.create('obj/32x32_hero-walk.png', 32, 32, 0.15)
        this.spr_jump = sprite.create('obj/32x32_hero-jump.png', 32, 32, 0.05)
